...
public class MyBorrowAdapter extends RecyclerView.Adapter<MyBorrowAdapter.ViewHolder> {
    ...
    public MyBorrowAdapter(Context context, List<BookJYInfo> infos, View.OnClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.rv_borrow_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.tvBookaddress.setText(infos.get(position).getBookaddress());
        holder.tvBookname.setText(infos.get(position).getBookname());
        holder.tvStartdate.setText(infos.get(position).getStartdate());
        holder.tvState.setText("借阅中");
